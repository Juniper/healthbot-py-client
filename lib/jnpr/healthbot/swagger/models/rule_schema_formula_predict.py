...
class RuleSchemaFormulaPredict(object):
    ...
    def learning_period(self):
        ...
        Learning period to learn the baseline threshold. Should be of pattern [1-9][0-9]*(seconds|minutes|hours|days|weeks|years|offset)  # noqa: E501
    ...
    def prediction_offset(self):
        ...
        Time offset in future to predict. Should be of pattern [1-9][0-9]*(offset|seconds|minutes|hours|days|weeks|years|s|m|h|d|w|y)  # noqa: E501
