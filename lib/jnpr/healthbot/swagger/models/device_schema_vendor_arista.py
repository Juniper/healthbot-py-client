...
class DeviceSchemaVendorArista(object):
    ...
    def __init__(self, operating_system=None, platform=None, product=None, release=None):  # noqa: E501
        """DeviceSchemaVendorArista - a model defined in Swagger"""  # noqa: E501
    ...
    def operating_system(self):
        """Gets the operating_system of this DeviceSchemaVendorArista.  # noqa: E501

        Operating system of the device  # noqa: E501

        :return: The operating_system of this DeviceSchemaVendorArista.  # noqa: E501
        :rtype: str
        """
    ...
    def operating_system(self, operating_system):
        """Sets the operating_system of this DeviceSchemaVendorArista.

        Operating system of the device  # noqa: E501

        :param operating_system: The operating_system of this DeviceSchemaVendorArista.  # noqa: E501
        :type: str
        """
        if operating_system is None:
            raise ValueError("Invalid value for `operating_system`, must not be `None`")  # noqa: E501
        allowed_values = ["eos"]  # noqa: E501
    ...
    @property
    def platform(self):
        """Gets the platform of this DeviceSchemaVendorArista.  # noqa: E501

        Platform name of the device, Example: MX240  # noqa: E501

        :return: The platform of this DeviceSchemaVendorArista.  # noqa: E501
        :rtype: str
        """
    ...
    def platform(self, platform):
        """Sets the platform of this DeviceSchemaVendorArista.

        Platform name of the device, Example: MX240  # noqa: E501

        :param platform: The platform of this DeviceSchemaVendorArista.  # noqa: E501
        :type: str
        """
    ...
    @property
    def product(self):
        """Gets the product of this DeviceSchemaVendorArista.  # noqa: E501

        Product category of the device, Example: MX  # noqa: E501

        :return: The product of this DeviceSchemaVendorArista.  # noqa: E501
        :rtype: str
        """
    ...
    def product(self, product):
        """Sets the product of this DeviceSchemaVendorArista.

        Product category of the device, Example: MX  # noqa: E501

        :param product: The product of this DeviceSchemaVendorArista.  # noqa: E501
        :type: str
        """
    ...
    @property
    def release(self):
        """Gets the release of this DeviceSchemaVendorArista.  # noqa: E501

        Release string of the device, Example: 19.2R1  # noqa: E501

        :return: The release of this DeviceSchemaVendorArista.  # noqa: E501
        :rtype: str
        """
    ...
    def release(self, release):
        """Sets the release of this DeviceSchemaVendorArista.

        Release string of the device, Example: 19.2R1  # noqa: E501

        :param release: The release of this DeviceSchemaVendorArista.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DeviceSchemaVendorArista, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeviceSchemaVendorArista):
            return False
