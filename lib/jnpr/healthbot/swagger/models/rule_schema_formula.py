...
class RuleSchemaFormula(object):
    ...
    def __init__(self, anomaly_detection=None, count=None, dynamic_threshold=None, eval=None, max=None, mean=None, microburst=None, min=None, outlier_detection=None, predict=None, rate_of_change=None, stddev=None, sum=None, user_defined_function=None):  # noqa: E501
