...
class RuleSchemaRulepropertiesSupporteddevicesOthervendor(object):
    ...
    def vendor_identifier(self, vendor_identifier):
        ...
        if vendor_identifier is not None and not re.search('^[a-zA-Z][a-zA-Z0-9_-]*$', vendor_identifier):  # noqa: E501
            raise ValueError("Invalid value for `vendor_identifier`, must be a follow pattern or equal to `/^[a-zA-Z][a-zA-Z0-9_-]*$/`")  # noqa: E501
