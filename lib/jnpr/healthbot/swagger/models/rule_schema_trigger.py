...
class RuleSchemaTrigger(object):
    ...
    swagger_types = {
        ...
        'frequency': 'str',
        'synopsis': 'str',
        'disable_alarm_deduplication': 'list[ERRORUNKNOWN]',
    ...
    def frequency(self, frequency):
        ...
        :type: str
        """
        if frequency is not None and not re.search('^[1-9][0-9]*(o|s|m|h|d|w|y|offset)$', frequency):  # noqa: E501
            raise ValueError("Invalid value for `frequency`, must be a follow pattern or equal to `/^[1-9][0-9]*(o|s|m|h|d|w|y|offset)$/`")  # noqa: E501
