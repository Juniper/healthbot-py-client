...
class RollupsummarizationSchemaField(object):
    ...
    def __init__(self, aggregate_function=None, name=None):  # noqa: E501
        """RollupsummarizationSchemaField - a model defined in Swagger"""  # noqa: E501
    ...
    def aggregate_function(self):
        """Gets the aggregate_function of this RollupsummarizationSchemaField.  # noqa: E501


        :return: The aggregate_function of this RollupsummarizationSchemaField.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def aggregate_function(self, aggregate_function):
        """Sets the aggregate_function of this RollupsummarizationSchemaField.


        :param aggregate_function: The aggregate_function of this RollupsummarizationSchemaField.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def name(self):
        """Gets the name of this RollupsummarizationSchemaField.  # noqa: E501

        Name of the field. Should be of pattern [a-z][a-zA-Z0-9_-]*  # noqa: E501

        :return: The name of this RollupsummarizationSchemaField.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this RollupsummarizationSchemaField.

        Name of the field. Should be of pattern [a-z][a-zA-Z0-9_-]*  # noqa: E501

        :param name: The name of this RollupsummarizationSchemaField.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RollupsummarizationSchemaField, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RollupsummarizationSchemaField):
            return False
