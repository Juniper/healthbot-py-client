...
from jnpr.healthbot.swagger.models.apply_macro_schema import ApplyMacroSchema  # noqa: F401,E501
from jnpr.healthbot.swagger.models.rule_schema_ruleproperties_catalogue import RuleSchemaRulepropertiesCatalogue  # noqa: F401,E501
from jnpr.healthbot.swagger.models.rule_schema_ruleproperties_helperfiles import RuleSchemaRulepropertiesHelperfiles  # noqa: F401,E501
from jnpr.healthbot.swagger.models.rule_schema_ruleproperties_supporteddevices import RuleSchemaRulepropertiesSupporteddevices  # noqa: F401,E501
...
class RuleSchemaRuleproperties(object):
    ...
    def __init__(self, author=None, catalogue=None, contributor=None, date=None, helper_files=None, supported_devices=None, supported_healthbot_version=None, version=None, apply_macro=None):  # noqa: E501
    ...
    def author(self, author):
        ...
        :type: str
        """
        if author is not None and not re.search('^([\\w\\-_\\.]+)@([\\w])+[.][\\w]+$', author):  # noqa: E501
    ...
    @property
    def date(self):
        """Gets the date of this RuleSchemaRuleproperties.  # noqa: E501


        :return: The date of this RuleSchemaRuleproperties.  # noqa: E501
        :rtype: str
        """
        return self._date
    ...
    @date.setter
    def date(self, date):
        """Sets the date of this RuleSchemaRuleproperties.


        :param date: The date of this RuleSchemaRuleproperties.  # noqa: E501
        :type: str
        """
        if date is not None and not re.search('^(19|20)\\d\\d[\/](0[1-9]|1[012])[\/](0[1-9]|[12][0-9]|3[01])$', date):  # noqa: E501
            raise ValueError("Invalid value for `date`, must be a follow pattern or equal to `/^(19|20)\\d\\d[\/](0[1-9]|1[012])[\/](0[1-9]|[12][0-9]|3[01])$/`")  # noqa: E501
    ...
    def supported_healthbot_version(self, supported_healthbot_version):
        ...
        :type: str
        """
        if supported_healthbot_version is not None and not re.search('^(\\d){1,2}[-.](\\d){1,2}[-.](\\d){1,2}$', supported_healthbot_version):  # noqa: E501
