...
class PlaybookSchema(object):
    ...
    def __init__(self, description=None, playbook_name=None, rules=None, synopsis=None):  # noqa: E501
    ...
    def playbook_name(self, playbook_name):
        ...
        if playbook_name is not None and not re.search('^[a-zA-Z][a-zA-Z0-9_-]*$', playbook_name):  # noqa: E501
