...
from jnpr.healthbot.swagger.models.report_schema_graphcanvas import ReportSchemaGraphcanvas  # noqa: F401,E501
...
class ReportSchema(object):
    ...
    def __init__(self, destination=None, format=None, graph_canvas=None, name=None, schedule=None):  # noqa: E501
