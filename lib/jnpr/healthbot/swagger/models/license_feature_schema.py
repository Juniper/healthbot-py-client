...
class LicenseFeatureSchema(object):
    ...
    def license_remaining(self, license_remaining):
        ...
        :type: int
        """
        if license_remaining is None:
            raise ValueError("Invalid value for `license_remaining`, must not be `None`")  # noqa: E501
    ...
    def license_requested(self, license_requested):
        ...
        :type: int
        """
        if license_requested is None:
            raise ValueError("Invalid value for `license_requested`, must not be `None`")  # noqa: E501
