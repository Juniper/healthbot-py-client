...
class TsdbPostBodyItems(object):
    ...
    def __init__(self, query_name=None, device_group=None, device=None, db=None, topic=None, rule=None, trigger=None, measurement=None, where=None, order=None, limit=None, fields=None, group_by=None):  # noqa: E501
