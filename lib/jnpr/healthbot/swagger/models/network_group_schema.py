...
from jnpr.healthbot.swagger.models.networkgroup_schema_publish import NetworkgroupSchemaPublish  # noqa: F401,E501
...
class NetworkGroupSchema(object):
    ...
    def __init__(self, description=None, ingest_frequency=None, network_group_name=None, publish=None, logging=None, reports=None, notification=None, playbooks=None, scheduler=None, variable=None):  # noqa: E501
    ...
    def network_group_name(self, network_group_name):
        ...
        if network_group_name is not None and not re.search('^[a-zA-Z][a-zA-Z0-9-]*$', network_group_name):  # noqa: E501
