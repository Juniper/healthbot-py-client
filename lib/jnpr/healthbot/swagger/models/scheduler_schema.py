...
from jnpr.healthbot.swagger.models.scheduler_schema_repeat import SchedulerSchemaRepeat  # noqa: F401,E501
from jnpr.healthbot.swagger.models.scheduler_schema_runfor import SchedulerSchemaRunfor  # noqa: F401,E501
...
class SchedulerSchema(object):
    ...
    def end_time(self, end_time):
        ...
        :type: str
        """
        if end_time is not None and not re.search('^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[01])T([0-1][0-9]|2[0-3]):[0-5][0-9]:[0-5][0-9]Z$', end_time):  # noqa: E501
            raise ValueError("Invalid value for `end_time`, must be a follow pattern or equal to `/^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[01])T([0-1][0-9]|2[0-3]):[0-5][0-9]:[0-5][0-9]Z$/`")  # noqa: E501
    ...
    def start_time(self, start_time):
        ...
        if start_time is not None and not re.search('^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[01])T([0-1][0-9]|2[0-3]):[0-5][0-9]:[0-5][0-9]Z$', start_time):  # noqa: E501
            raise ValueError("Invalid value for `start_time`, must be a follow pattern or equal to `/^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[01])T([0-1][0-9]|2[0-3]):[0-5][0-9]:[0-5][0-9]Z$/`")  # noqa: E501
