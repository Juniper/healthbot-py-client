...
from jnpr.healthbot.swagger.models.ingestmapping_schema_i_agent import IngestmappingSchemaIAgent  # noqa: F401,E501
...
class IngestMappingSchema(object):
    ...
    swagger_types = {
        ...
        'name': 'str',
        'native_gpb': 'IngestmappingSchemaIAgent',
        'netflow': 'IngestmappingSchemaIAgent',
        'open_config': 'IngestmappingSchemaIAgent',
        'snmp': 'IngestmappingSchemaIAgent',
        'syslog': 'IngestmappingSchemaIAgent'
    }
