...
class RawSchemaDatatype(object):
    ...
    def __init__(self, aggregation_functions=None, name=None):  # noqa: E501
        """RawSchemaDatatype - a model defined in Swagger"""  # noqa: E501
    ...
    def aggregation_functions(self):
        """Gets the aggregation_functions of this RawSchemaDatatype.  # noqa: E501


        :return: The aggregation_functions of this RawSchemaDatatype.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def aggregation_functions(self, aggregation_functions):
        """Sets the aggregation_functions of this RawSchemaDatatype.


        :param aggregation_functions: The aggregation_functions of this RawSchemaDatatype.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def name(self):
        """Gets the name of this RawSchemaDatatype.  # noqa: E501

        Name of the data-type for which summarization should be changed  # noqa: E501

        :return: The name of this RawSchemaDatatype.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this RawSchemaDatatype.

        Name of the data-type for which summarization should be changed  # noqa: E501

        :param name: The name of this RawSchemaDatatype.  # noqa: E501
        :type: str
        """
        if name is None:
            raise ValueError("Invalid value for `name`, must not be `None`")  # noqa: E501
        allowed_values = ["string", "integer", "unsigned-integer", "boolean", "float"]  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RawSchemaDatatype):
            return False
