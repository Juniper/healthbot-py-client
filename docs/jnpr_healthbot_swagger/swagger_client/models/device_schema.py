...
class DeviceSchema(object):
    ...
    def __init__(self, authentication=None, description=None, device_id=None, flow=None, host=None, i_agent=None, open_config=None, snmp=None, syslog=None, tagging_profile=None, timezone=None, system_id=None, variable=None, vendor=None):  # noqa: E501
