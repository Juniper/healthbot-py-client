...
class NetworkGroupSchema(object):
    ...
    def __init__(self, description=None, ingest_frequency=None, network_group_name=None, publish=None, logging=None, reports=None, notification=None, playbooks=None, tagging_profile=None, scheduler=None, variable=None):  # noqa: E501
