...
version = jnpr.healthbot._version.get_versions()["version"]
...
man_pages = [
    ('index', 'healthbot', u'Juniper HealthBot Python client Documentation',
...
# order functions as per coded in file
